...
class ProductResultsPage{
    ...
    constructor(){
       /* 
       Originally used the selector below but testCafe couldn't reliably click the link (I believe it was too short and sometimes it clicks on the whitespace right next to the span instead)
